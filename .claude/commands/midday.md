---
description: Run the midday scan workflow locally using .env credentials
---
...
STEP 5 — Thesis check. Cut on broken thesis even if not at -7%.

STEP 6 — Optional intraday research via Perplexity if something is moving sharply.
