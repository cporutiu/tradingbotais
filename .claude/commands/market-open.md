---
description: Run the market-open execution workflow locally using .env credentials
---
...
If rejected (PDT), fall back to fixed stop. If also blocked, queue in TRADE-LOG.
